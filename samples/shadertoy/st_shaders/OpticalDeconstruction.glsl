...
vec3 G(vec3 a, float b){a=fract(a*.2)*2.-1.;a.z=b;
 float m=0.0; //iMouse.x/iResolution.x;
...
float T(vec3 a){
 float m=0.0; //iMouse.y/iResolution.y;
...
vec4 RayTrace (const Ray ray, in vec2 Uuu){

...
bool RayTracingApp::CreateBindingTable (ResourceInit &res)
{
	...
	{
		Array<uint8_t>	handles;  handles.resize( NUM_GROUPS * stride );
		...
		vkCmdUpdateBuffer( cmd, shaderBindingTable, alignment * HIT_SHADER,		stride, handles.data() + BytesU{stride * HIT_SHADER} );
